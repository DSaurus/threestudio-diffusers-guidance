...
@threestudio.register("diffusers-deep-floyd-guidance")
class DiffusersDFGuidance(DiffusersGuidance):
    ...
    def create_pipe(self):
        HookIFPipeline = type('HookIFPipeline', (IFPipeline,), {'prepare_intermediate_images': prepare_intermediate_images})

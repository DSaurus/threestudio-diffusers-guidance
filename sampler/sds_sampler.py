...
class SDSSampler():
    ...
    def init_sds_sampler(
        ...
        SDSScheduler = type('SDSScheduler', (DDIMScheduler,), {'set_timesteps': sds_set_timesteps})
    ...
    def compute_grad_sds(
        ...
        **kwargs
        ...
        loss_sds = 0.5 * F.mse_loss(latents, pred_latents.detach().to(noisy_latents), reduction="sum") / batch_size
